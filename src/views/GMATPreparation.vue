...
import Hero from "@/components/TestPrepration/GMAT/Hero.vue";
import Intro from "@/components/TestPrepration/GMAT/Intro.vue";
import fotter from "@/components/layouts/fotter.vue";
import Who from "../components/TestPrepration/GMAT/Who.vue";
</script>
