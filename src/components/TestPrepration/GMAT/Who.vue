      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div class="flex flex-col justify-center">
          ...
          <p class="text-gray-700 leading-relaxed text-base mb-4">
            The GMAT is intended for students applying to MBA programs and other
            graduate management degrees. Business schools worldwide use GMAT
            scores to evaluate applicants' readiness for advanced study in
            mathematics, analytical writing, and verbal reasoning.
          </p>
          ...
          <p class="text-gray-700 leading-relaxed text-base mb-4">
            The GMAT consists of three main sections: Analytical Writing
            Assessment, Verbal Ability, and Quantitative Reasoning. It is
            primarily computer-based, though paper-based versions may be offered
            in areas with limited computer access.
          </p>
          ...
          <p class="text-gray-700 leading-relaxed text-base">
            Scores range from 200 to 800. Exam scores are valid for five years.
            Business schools typically use these scores to compare candidates
            and determine admission eligibility.
          </p>
        </div>
  ...
  <section class="py-16 px-4 md:px-8 lg:px-16">
    <div class="container mx-auto text-center">
      ...
      <p class="text-xl text-blue-100 mb-8">
        Enroll your GMAT Preparation Class with Grace International
      </p>
      <button
