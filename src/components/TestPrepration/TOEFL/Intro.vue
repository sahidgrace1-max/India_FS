      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div class="flex flex-col justify-start space-y-4">
          ...
          <p class="text-gray-800 leading-relaxed text-lg">
            The TOEFL iBT® test, administered via the Internet, is an important part of your journey to study in an English-speaking country. It measures your ability to use and understand English at the university level, combining listening, reading, speaking, and writing skills to perform academic tasks. More than 30 million people worldwide have taken the TOEFL® test, with English skill levels ranging from Intermediate to Advanced.
          </p>
          
          <h2 class="text-2xl font-semibold text-gray-900 mt-4">Who is it for?</h2>
          <ul class="list-disc list-inside text-gray-800 leading-relaxed text-lg space-y-1">
          ...
          <h2 class="text-2xl font-semibold text-gray-900 mt-4">Why TOEFL?</h2>
          <ul class="list-disc list-inside text-gray-800 leading-relaxed text-lg space-y-1">
            <li>Scores Help You Stand Out</li>
            <li>Rates Speaking More Fairly</li>
            <li>Measures Academic Skills</li>
            <li>More Choices & More Convenient</li>
          </ul>
        </div>  
      </div>
    </div>
