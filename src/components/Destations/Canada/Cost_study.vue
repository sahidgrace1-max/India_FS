  ...
  >
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        <div 
          class="order-1 lg:order-1 flex flex-col justify-start transition-all duration-1000 ease-out transform"
        ...
        >
          ...
          <h2 class="text-3xl sm:text-4xl font-bold text-blue-900 mb-8 leading-tight">
            Cost of Studying in 
          ...
          <div class="bg-white/70 backdrop-blur-sm border border-blue-100 p-6 sm:p-8 rounded-2xl shadow-sm mb-10">
            <ul class="space-y-4 text-slate-700 text-lg">
              <li class="flex items-start">
                ...
                <div><span class="font-bold text-blue-900">Tuition Fees:</span> CAD <span class="font-semibold text-blue-800">15,000–30,000/year</span> (approx.) depending on the program.</div>
              </li>
              <li class="flex items-start">
                <span class="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <div><span class="font-bold text-blue-900">Living Costs:</span> CAD <span class="font-semibold text-blue-800">10,000–15,000/year</span> depending on city and lifestyle.</div>
              </li>
              <li class="flex items-start">
                <span class="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <div><span class="font-bold text-blue-900">Average Total:</span> CAD <span class="font-semibold text-blue-800">25,000–45,000/year</span>.</div>
              </li>
            </ul>
            <p class="mt-6 text-slate-600 font-medium italic border-l-4 border-green-400 pl-4 py-1">
              Grace International helps students plan budgets, choose affordable institutions, and manage living expenses effectively.
            </p>
          </div>
          ...
          <div class="grid gap-4">
            <div class="bg-white/70 backdrop-blur-sm border border-blue-100 p-5 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <h4 class="font-bold text-blue-900 mb-2 flex items-center gap-3">
                <span class="text-green-500 text-xl bg-green-50 w-8 h-8 flex items-center justify-center rounded-lg">💼</span>
                Part-Time Work
              </h4>
              <p class="text-slate-700 text-sm">Up to 20 hours per week during study sessions and full-time during scheduled breaks.</p>
            </div>
            <div class="bg-white/70 backdrop-blur-sm border border-blue-100 p-5 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <h4 class="font-bold text-blue-900 mb-2 flex items-center gap-3">
                <span class="text-green-500 text-xl bg-green-50 w-8 h-8 flex items-center justify-center rounded-lg">✈️</span>
                Post-Graduation Work Permit (PGWP)
              </h4>
              <p class="text-slate-700 text-sm">Allows students to work in Canada for up to 3 years after completing an eligible program.</p>
            </div>
            <div class="bg-green-50 border border-green-200 rounded-2xl p-5">
              ...
              <p class="text-slate-700 text-sm italic">International students can apply for permanent residency through programs such as Express Entry and Provincial Nominee Programs (PNP) after gaining skilled work experience.</p>
            </div>
          </div>
        </div>
