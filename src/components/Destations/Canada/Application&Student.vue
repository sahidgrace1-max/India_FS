        ...
        >
          ...
          <div class="bg-white/70 backdrop-blur-sm border border-blue-100 p-6 sm:p-8 rounded-2xl shadow-sm mb-10">
            <ul class="space-y-4 text-slate-700 text-lg">
              <li class="flex items-start">
                ...
                <div><span class="font-bold text-blue-900">Major Intakes:</span> September is the main intake, with January and May start dates for select programs.</div>
              </li>
              <li class="flex items-start">
                <span class="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <div><span class="font-bold text-blue-900">Requirements:</span> Academic transcripts, proof of English proficiency (IELTS, PTE, TOEFL), SOP, LORs, and financial proof.</div>
              </li>
              <li class="flex items-start">
                <span class="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <div><span class="font-bold text-blue-900">Study Permit:</span> Required for studies longer than 6 months. Must show proof of acceptance, sufficient funds for tuition + living, and a valid passport.</div>
              </li>
            </ul>
            <p class="mt-6 text-slate-600 font-medium italic border-l-4 border-green-400 pl-4 py-1">
              Grace International India helps students with every step of the Canada student visa process, from document preparation to application guidance.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="bg-white/50 backdrop-blur-sm border border-blue-50 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow flex items-start gap-3">
              ...
              <span class="text-slate-700 text-sm font-medium">Direct tie-ups with top Canadian universities.</span>
            </div>
            <div class="bg-white/50 backdrop-blur-sm border border-blue-50 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow flex items-start gap-3">
              <span class="text-green-500 text-xl">🛡️</span>
              <span class="text-slate-700 text-sm font-medium">End-to-end support: counselling, visas, scholarships.</span>
            </div>
            <div class="bg-white/50 backdrop-blur-sm border border-blue-50 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow flex items-start gap-3">
              <span class="text-green-500 text-xl">📈</span>
              <span class="text-slate-700 text-sm font-medium">Guidance on post-study work permits & PR.</span>
            </div>
            <div class="bg-white/50 backdrop-blur-sm border border-blue-50 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow flex items-start gap-3">
              <span class="text-green-500 text-xl">🤝</span>
              <span class="text-slate-700 text-sm font-medium">Pre-departure & settling-in guidance.</span>
            </div>
            <div class="bg-white/50 backdrop-blur-sm border border-blue-50 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow flex items-start gap-3 sm:col-span-2">
              <span class="text-green-500 text-xl">🏆</span>
              <span class="text-slate-700 text-sm font-medium">Leading Canada consultants in India with 20+ years expertise.</span>
            </div>
          </div>
        </div>
        ...
        >
          <div class="relative group w-full max-w-lg lg:max-w-none">
            ...
            <img
              ...
              class="relative rounded-3xl shadow-xl w-full h-auto object-cover border-4 border-white min-h-[450px] lg:min-h-[800px]"
            />
          </div>
        </div>
      </div>
