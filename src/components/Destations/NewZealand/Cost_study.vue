      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        >
          ...
          <div class="bg-white/70 backdrop-blur-sm border border-blue-100 p-6 sm:p-8 rounded-2xl shadow-sm mb-10">
            <ul class="space-y-4 text-slate-700 text-lg">
              <li class="flex items-start">
                ...
                <div><span class="font-bold text-blue-900">Tuition Fees:</span> NZ$20,000–$75,000/year depending on program and institution.</div>
              </li>
              <li class="flex items-start">
                <span class="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <div><span class="font-bold text-blue-900">Living Costs:</span> Average NZ$120–$200/week depending on accommodation type.</div>
              </li>
              <li class="flex items-start">
                <span class="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <div><span class="font-bold text-blue-900">Estimated Total:</span> Approximately NZ$25,000–NZ$30,000 per year.</div>
              </li>
            </ul>
            <p class="mt-6 text-slate-600 font-medium italic border-l-4 border-green-400 pl-4 py-1">
              Grace International India assists Indian students with budgeting, financial planning, and documentation for studying in New Zealand.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="bg-white/50 backdrop-blur-sm border border-blue-50 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <div class="flex items-start gap-3">
                <span class="text-green-500 text-xl">⏳</span>
                <span class="text-slate-700 text-sm font-medium">Part-time work: 20 hours/week during study.</span>
              </div>
            </div>
            <div class="bg-white/50 backdrop-blur-sm border border-blue-50 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <div class="flex items-start gap-3">
                <span class="text-green-500 text-xl">✈️</span>
                <span class="text-slate-700 text-sm font-medium">Post-study work visas: 1–3 years duration.</span>
              </div>
            </div>
            <div class="bg-white/50 backdrop-blur-sm border border-blue-50 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow sm:col-span-2">
              <div class="flex items-start gap-3">
                <span class="text-green-500 text-xl">🚀</span>
                <span class="text-slate-700 text-sm font-medium">Opportunities in IT, healthcare, engineering, and tourism.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div 
          class="order-2 lg:order-2 flex justify-center transition-all duration-1000 ease-out delay-300 transform"
