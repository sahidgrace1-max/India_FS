        ...
        >
          ...
          <div class="space-y-4">
            <div class="bg-white/70 backdrop-blur-sm border border-blue-100 p-5 rounded-2xl shadow-sm">
              <p class="font-bold text-blue-900">New Zealand Excellence Awards</p>
              <p class="text-slate-600 text-sm">Fully funded scholarships for high-achieving international students.</p>
            </div>
            <div class="bg-white/70 backdrop-blur-sm border border-blue-100 p-5 rounded-2xl shadow-sm">
              <p class="font-bold text-blue-900">University Merit & Tuition Waivers</p>
              <p class="text-slate-600 text-sm">Offered by institutions like Auckland, Waikato, and Canterbury.</p>
            </div>
          </div>
