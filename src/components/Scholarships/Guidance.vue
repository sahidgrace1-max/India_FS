<template>
  <div class="flex justify-center gap-16 mt-10 mb-10">
    <div class="flex-1 max-w-xl">
      <h2 class="text-2xl font-bold mb-2 text-gray-900">We Provide</h2>
    ...
    <div class="flex-1 max-w-xl">
      <h2 class="text-2xl font-bold mb-2 text-gray-900">Guidance and Advice</h2>
      <div class="w-11/12 h-1 bg-green-400 mb-6"></div>
      <div class="text-base text-gray-600">
        <p>
